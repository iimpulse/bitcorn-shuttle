...
import {
  ...
  LanguageCode,
} from '../../../assets/lib/charting_library/charting_library.min';
...
export class ChartComponent implements OnInit, OnDestroy {11
  private _symbol: ChartingLibraryWidgetOptions['symbol'] = 'AAPL';
  private _interval: ChartingLibraryWidgetOptions['interval'] = 'D';
  // BEWARE: no trailing slash is expected in feed URL
  private _datafeedUrl = 'https://demo_feed.tradingview.com';
  private _libraryPath: ChartingLibraryWidgetOptions['library_path'] = '/assets/lib/charting_library/';
